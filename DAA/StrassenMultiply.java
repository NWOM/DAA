...
public class StrassenMultiply {
    ...
    private static int[][] StrassenMultiply(int[][] A, int[][] B) {
        ...
        int[][] res = new int[n][n];
        //DIVIDE AND CONQUER
        //T(n)=8T(n/2)+n^2(for addition additional n^2) ; n>2
        //T(n)=1  ;n=<2
        //to generalize the n>2 condititon by applying masters theorem 
        //a=8 b=2 log(a) base b= log(8)b2=3 and n^k=n^2 so k=2 therefore theta(n^3)
        ...
        if (n == 1) {
            ...
            **/
            ...
            int[][] p1 = StrassenMultiply(addMatrices(a, d), addMatrices(e, h)); //Multiplication of addition of the diagonal element 
